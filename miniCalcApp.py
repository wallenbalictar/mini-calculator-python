...
# Function to show pressed value to the label
def show(value):
    global equation
    equation += value
...
# Calculating the value in the label
def calculate():
    global equation
    result = ""
    if equation != "":
...
if __name__ == '__main__':
    root = Tk()
    root.title = "Mini Calculator App"
    ...
    Button(root,text="Mod", width=5, height=1, font=("arial",30,"bold"), bd=1, fg="#fff", bg="#2a2d36", command=lambda: show("%")).place(x=150, y=100)
